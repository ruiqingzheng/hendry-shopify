        ...
        <Layout.Section>
          <Form>
            ...
            <FormLayout>
              ...
              >
                <Card.Section>
                  {showResourcePicker && <ResourcePicker resourceType="Product" showVariants={false} selectMultiple={false} onCancel={toggleResourcePicker} onSelection={handleProductChange} open />}
                  {productId.value ? (
                    <Stack alignment="center">
                      {imageSrc || originalImageSrc ? <Thumbnail source={imageSrc || originalImageSrc} alt={altText} /> : <Thumbnail source={ImageMajor} color="base" size="small" />}
              ...
              >
                <Select label="discount code" options={discountOptions} onChange={handleDiscountChange} value={discountId.value} disabled={isLoadingDiscounts || discountsError} labelHidden />
              </Card>
            </FormLayout>
          </Form>
        </Layout.Section>
